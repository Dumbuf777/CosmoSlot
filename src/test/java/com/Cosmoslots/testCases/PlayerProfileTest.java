...
public class PlayerProfileTest extends BaseClass {
	BaseClass bc = new BaseClass();

	String[] month = { "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" };
	String[] endDate = { "31", "28", "27", "30", "10", "30", "31", "31", "30", "31", "30", "31" };
	public String currenttime = new SimpleDateFormat("yyyy/MM/dd h:m a").format(new Date());
	...
	// String packge = "Cosmo10 (Act Amt. $1)";
	String packge = "starpack4kTf";
	public String ProfilePlayerId = "";
	String SearchItemSupportRequest = "CS-SR-2936";// "GJTS-SR-1079";
	String SearchItemPlayerLedger = "Deposit";
	String SearchItemTrancsationHistory = "91ae2aac-417e-4357-adf2-d89782ed1cb7";
	String SearchItemWithdrawRequest = "CS-1222";// "GJTS-1105";
	String SearchItemPurchaseHistory = "CS-1877";// "GJTS-1086";
	String SearchPlayer = "Bhadresh Patel";// "Magritte";
	String Skrillid = "itsupport@ombpmllp.com";
	String cashappid = "itsupport@ombpmllp.com";
	String PlayerId = "CS-1400";
	String SearchPlayerName = "Shrikrushna Sonkar";
	String Pkgamount = "10";
	String GT = "100";
	String ST = "100";
	...
	public void A_TC_PlayerProfile_GF3026_Redirect() throws InterruptedException, IOException {
		...
		test.info(
				"TestCase started 3026 - As an admin user I should able to view Players listing screen by clicking on Players Management");
		...
		if (driver.findElement(By.xpath("//h3[text()=\"Player Management\"]")) != null) {
			test.pass("Successfully Opened Players Listing screen");
		} else {
	...
	public void Ba_TC_PlayerProfile_GF3026_() throws InterruptedException, IOException {
		test = extentCreateTest(
				"TestCase started Edit Player Profile on website - As an admin user I should be able to Search Store_Game");
	...
	@Test
	public void C_TC_PlayerProfileTest_GF3027_ViewAvtar() throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> View Avtar");
		test.info(
				"TestCase started 3027 - As an admin user I should able to view Avtar of the Player on the Players listing");
	...
	@Test
	public void D_TC_PlayerProfileTest_GF3028_ViewDetails() throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> View FirstName Field");
		test.info(
				"TestCase started 3028 - As an admin user I should able to view Player Name(First Name + Last Name) on the Players listing");
...
//	@Test
//	public void E_TC_PlayerProfileTest_GF3029_Phone() throws InterruptedException, IOException {
//		test = extentCreateTest("Player Profile -> Phone Field");
//		test.info("TestCase started 3029 - As an admin user I should able to view Phone field in the list of Players");
//		
//		if (driver.findElement(By.xpath("//h3[text()=\"Player Management\"]")) != null) {
//			test.info("Already Opened Players Listing screen");
//
//			if (driver.findElements(By.xpath("//th[text()=\"Phone\"]/following::tr//td[contains(@class,\"phone\")]"))
//					.size() > 0) {
//				Assert.assertTrue(true);
//				test.pass("Successfully Viewed Phone of Player on the player listing page");
//			} else {
//				Assert.assertTrue(false);
//				test.fail("Something wrong !! To Viewed Phone of Player on the player listing page");
//				captureScreen(driver, "PlayerProfilePhone");
//			}
//		} else {
//			test.fail("Something wrong!To Open Player Profile");
//		}
...
//
//	@Test
//	public void F_TC_PlayerProfileTest_GF3030_Email() throws InterruptedException, IOException {
//		test = extentCreateTest("Player Profile -> Email Field");
//		test.info("TestCase started 3030 - As an admin user I should able to view Email field in the list of Players");
//	
//		if (driver.findElement(By.xpath("//h3[text()=\"Player Management\"]")) != null) {
//			test.info("Already Opened Players Listing screen");
//			if (driver.findElements(By.xpath("//th[text()=\"Email\"]/following::tr//td[contains(@class,\"email\")]")).size() > 0) {
//				Assert.assertTrue(true);
//				test.pass("Successfully Viewed Email of Player on the player listing page");
//			} else {
//				Assert.assertTrue(false);
//				test.fail("Something wrong !! To Viewed Email of Player on the player listing page");
//				captureScreen(driver, "PlayerProfileEmail");
//			}
//		} else {
...
//
//	@Test
//	public void G_TC_PlayerProfileTest_GF3031_Country() throws InterruptedException, IOException {
//		test = extentCreateTest("Player Profile -> Country Field");
//		test.info("TestCase started 3031 - As an admin user I should able to view Country field in the list of Players");
//		
//		if (driver.findElement(By.xpath("//h3[text()=\"Player Management\"]")) != null) {
//			test.info("Already Opened Players Listing screen");
//
...
//					.size() > 0) {
//				Assert.assertTrue(true);
//				test.pass("Successfully Viewed Country of Player on the player listing page");
//			} else {
//				Assert.assertTrue(false);
//				test.fail("Something wrong !! To Viewed Country of Player on the player listing page");
//				captureScreen(driver, "PlayerProfileCountry");
//			}
//		} else {
//			test.fail("Something wrong!To Open Player Profile");
//		}
...
//
//	@Test
//	public void H_TC_PlayerProfileTest_GF3032_State() throws InterruptedException, IOException {
//		test = extentCreateTest("Player Profile -> State Field");
//		test.info("TestCase started 3032 - As an admin user I should able to view State field in the list of Players");
//		if (driver.findElement(By.xpath("//h3[text()=\"Player Management\"]")) != null) {
//			test.info("Already Opened Players Listing screen");
//			if (driver.findElements(By.xpath("//th[text()=\"Location\"]/following::tr//td[contains(@class,\"state\")]"))
//					.size() > 0) {
//				Assert.assertTrue(true);
//				test.pass("Successfully Viewed Location of Player on the player listing page");
//			} else {
//				test.fail("Something wrong !! To Viewed Location of Player on the player listing page");
//				captureScreen(driver, "PlayerProfileCountry");
//				Assert.assertTrue(false);
//			}
//		} else {
...
//
//	@Test
//	public void I_TC_PlayerProfileTest_GF3033PlayerId() throws InterruptedException, IOException {
//		test = extentCreateTest("Player Profile -> PlayerId Field");
//		test.info(
//				"TestCase started 3033 - As an admin user I should able to view Player Id field in the list of Players");
//		// test.info("Create NewPlayer Testcase started");
...
//					.size() > 0) {
//				Assert.assertTrue(true);
//				test.pass("Successfully Viewed PlayerId of Player on the player listing page");
//			} else {
//				Assert.assertTrue(false);
//				test.fail("Something wrong !! To Viewed PlayerId of Player on the player listing page");
//				// captureScreen(driver,"PlayerProfilePlayerId");
//			}
//		} else {
//			test.fail("Something wrong!To Open Player Profile");
//		}
...
//
//	@Test
//	public void J_TC_PlayerProfileTest_GF3034_Status() throws InterruptedException, IOException {
//		test = extentCreateTest("Player Profile -> Status Field");
//		test.info(
//				"TestCase started 3034 - As an admin user I should able to view Status button in the list of Players, so that user can change the status by clicking on it");
//		// test.info("Create NewPlayer Testcase started");
//		PlayerProfile pp = new PlayerProfile(driver);
//		// Thread.sleep(4000);
//		// gp.clickPlayerManagement1Link();
...
//			test.info("Already Opened Players Listing screen");
//
//			if (driver.findElements(By.xpath("//th[text()=\"Status\"]/following::tr//td[contains(@class,\"active\")]"))
//					.size() > 0) {
//				Assert.assertTrue(true);
//				test.pass("Successfully Viewed Status of Player on the player listing page");
//			} else {
//				Assert.assertTrue(false);
//				test.fail("Something wrong !! To Viewed Status of Player on the player listing page");
...
//
	@Test
	public void K_TC_PlayerProfileTest_GF3035ViewInfo() throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> ViewInfo Action");
		test.info(
				"TestCase started 3035 - As an admin user I should able to view info icon in the 'View' field of Players list");
...
//	@Test
	public void L_TC_PlayerProfileTest_Edit() throws InterruptedException, IOException {
...
//				GuestPlayers.SkrillId.clear();
//				GuestPlayers.SkrillId.sendKeys(Skrillid);
//				GuestPlayers.CashAppId.clear();
//				GuestPlayers.CashAppId.sendKeys(cashappid);
				JavascriptExecutor js1 = (JavascriptExecutor) driver;
				js1.executeScript("window.scrollBy(0,250)", "");
				Thread.sleep(500);
				gp.ClickSave();
	...
	@Test
	public void M_TC_PlayerProfileTest_Searchplayer() throws InterruptedException, IOException {
		Thread.sleep(2000);
		...
		if (driver.findElement(By.xpath("//h3[text()=\"Player Management\"]")) != null) {
			...
			Thread.sleep(1500);
			if (driver.findElement(By.xpath("//td[contains(.,'" + PlayerId + "')]")) != null) {
...
//	@Test
//	public void Ma_TC_PlayerProfileTest_GF3070ActiveInactive() throws InterruptedException, IOException 
//	{
//		Thread.sleep(2000);
//		test = extentCreateTest("Player Profile -> Active/InActive Player");
//		test.info("TestCase started 3070 - As an admin user I should be able to change players status i.e. Active/Blocked");
//		//test.info("Create NewPlayer Testcase started");
//		PlayerProfile pp=new PlayerProfile(driver);
//		//Thread.sleep(4000);
//		//gp.clickPlayerManagement1Link();
...
//		{
//			test.info("Already Opened Players Listing screen");
//			driver.findElement(By.xpath("//th[text()=\"No\"]")).click();
//			JavascriptExecutor js1 = (JavascriptExecutor) driver;
//			js1.executeScript("window.scrollBy(250,0)", "");
//			
//			if(driver.findElement(By.xpath("//th[text()=\"Status\"]/following::tr//td[contains(@class,\"active\")]//span[@title]")).getAttribute("title").equalsIgnoreCase("In Active"))
//			{
//				test.info("Successfully Viewed View Icon of Player on the player listing page");
//				test.info("Now Player Is In Active");
//				driver.findElement(By.xpath("(//th[text()=\"Status\"]/following::tr//td[contains(@class,\"active\")]//span[contains(@class,'thumb-container')])[1]")).click();
//				Thread.sleep(1000);
//				driver.findElement(By.xpath("//button[text()=\"Yes\"]")).click();
//				Thread.sleep(1000);
//				try 
//				{
//					if(driver.findElements(By.xpath("//span[text()=\"Player Profile activated successfully\"]")).size()>0)
//					{
//						//Assert.assertTrue(true);
//						test.pass("User Successfully activated and Validation message appeared - Player Profile activated successfully");
//					}
//					else
//					{
//						//Assert.assertTrue(false);
...
//				catch(Exception e)
//				{
//					if(driver.findElement(By.xpath("//span[text()=\"Player Profile activated successfully\"]"))!=null)
//					{
//						//Assert.assertTrue(true);
//						test.pass("User Successfully activated and Validation message appeared - Player Profile activated successfully");
//					}
...
//				Thread.sleep(1000);
//				try {
//				if(driver.findElements(By.xpath("//span[text()=\"Player Profile deactivated successfully\"]")).size()>0)
//				{
//					//Assert.assertTrue(true);
//					test.pass("User Successfully deactivated and Validation message appeared - Player Profile deactivated successfully");
//				}
//				else
//				{
//					//Assert.assertTrue(false);
...
//					{
//						//Assert.assertTrue(true);
//						test.info("User Successfully deactivated and Validation message appeared - Player Profile deactivated successfully");
//					}	
//					System.out.println(e);
//				}
//			}
//			
////			if(driver.findElements(By.xpath("//th[text()=\"Status\"]/following::tr//td[contains(@class,\"active\")]")).size()>0)
////			{
////				test.info("Successfully Viewed View Icon of Player on the player listing page");
////				
////				driver.findElement(By.xpath("(//th[text()=\"Status\"]/following::tr//td[contains(@class,\"active\")]//span[contains(@class,'thumb-container')])[1]")).click();
...
////					test.info("User Successfully deactivated and Validation message appeared - Player Profile deactivated successfully");
////				}
////				else if(driver.findElements(By.xpath("//span[text()=\"Player Profile activated successfully\"]")).size()>0)
////				{
////					Assert.assertTrue(true);
////					test.info("User Successfully activated and Validation message appeared - Player Profile activated successfully");
////				}
////				else
////				{
////					Assert.assertTrue(false);
...
//	}
	...
	@Test
	public void N_TC_PlayerProfileTest_ActionViewTabsProfile() throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> Profile Tab");
		test.info("TestCase started As an admin user i should view (Action) -> Profile Tab");
		pp = new PlayerProfile(driver);
		// Thread.sleep(4000);
		// gp.clickPlayerManagement1Link();
	...
	@Test
	public void Nb_TC_PlayerProfileTest_ActionViewTabsAddTokensByPackageOthers()
		...
		PlayerProfileTest_ManageTokens(packge, "", "", "Others ", GT, ST);
	...
	@Test
	public void Nc_TC_PlayerProfileTest_ActionViewTabsAddTokensByPackageCashApp()
			throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> Add Token -> By Package with payment method - CashApp");
		test = extentCreateTest(
				"TestCase started As  admin user I should be able to Add Token (Action) -> Add Tokens Tab [By Package]");
		PlayerProfileTest_ManageTokens(packge, Pkgamount, "", "CashApp ", GT, ST);
	...
	@Test
	public void Nd_TC_PlayerProfileTest_ActionViewTabsAddTokensByPackageManual()
			throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> Add Token -> By Package with payment method - Manual");
		test = extentCreateTest(
				"TestCase started As  admin user I should be able to Add Token (Action) -> Add Tokens Tab [By Package]");
		PlayerProfileTest_ManageTokens(packge, Pkgamount, "", "Manual ", GT, ST);
...
//	@Test
	public void Ne_TC_PlayerProfileTest_ActionViewTabsAddTokensByPackagePaysafe()
			throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> Add Token -> By Package with payment method - Paysafe");
		test = extentCreateTest(
				"TestCase started As  admin user I should be able to Add Token (Action) -> Add Tokens Tab [By Package]");
		PlayerProfileTest_ManageTokens(packge, Pkgamount, "", "Paysafe ", GT, ST);
...
//	@Test
	public void Nf_TC_PlayerProfileTest_ActionViewTabsAddTokensByPackageSkrill()
			throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> Add Token -> By Package with payment method - Skrill");
		test = extentCreateTest(
				"TestCase started As  admin user I should be able to Add Token (Action) -> Add Tokens Tab [By Package]");
		PlayerProfileTest_ManageTokens(packge, Pkgamount, "", "Skrill ", GT, ST);
...
//	@Test
	public void Ng_TC_PlayerProfileTest_ActionViewTabsAddTokensByPackageBankCard()
			throws InterruptedException, IOException {
		test = extentCreateTest("Player Profile -> Add Token -> By Package with payment method - BankCard");
		test = extentCreateTest(
				"TestCase started As  admin user I should be able to Add Token (Action) -> Add Tokens Tab [By Package]");
		PlayerProfileTest_ManageTokens(packge, Pkgamount, "", "Bank Card ", GT, ST);
	...
	@Test
	public void Ne_TC_PlayerProfileTest_ActionViewTabsManageTokensWithdrawTokens()
			throws InterruptedException, IOException {
	...
	@Test
	public void O_TC_PlayerProfileTest_ActionViewTabsTokenDetails() throws InterruptedException, IOException {
	...
	@Test
	public void Oa_TC_PlayerProfileTest_ProfileTokenVerifyWeb() throws InterruptedException, IOException {
	...
	@Test
	public void P_TC_PlayerProfileTest_ActionViewTabsPurchaseHistorySearch() throws InterruptedException, IOException {
		...
		pp.clickonPurchases();
		Thread.sleep(3000);
		gp.Search_Items(SearchItemPurchaseHistory);
		System.out.println("player name on purchase history ->" + SearchItemPurchaseHistory);
		if (driver.findElement(By.xpath("//td[contains(text(),'" + SearchItemPurchaseHistory + "')]")) != null) {
	...
	@Test
	public void Qa_TC_PlayerProfileTest_PlayerPurchaseHistoryDownloadReciept()
			throws InterruptedException, IOException {
	...
	@Test
	public void R_TC_PlayerProfileTest_ActionViewTabsPurchaseHistoryXLSX() throws InterruptedException, IOException {
	...
	@Test
	public void S_TC_PlayerProfileTest_ActionViewTabsPurchaseHistoryAction() throws InterruptedException, IOException {
	...
	@Test
	public void T_TC_PlayerProfileTest_ActionViewTabsWithdrawRequestSearch() throws InterruptedException, IOException {
	...
	@Test
	public void V_TC_PlayerProfileTest_ActionViewTabsWithdrawRequestXLSX() throws InterruptedException, IOException {
	...
	@Test
	public void W_TC_PlayerProfileTest_ActionViewTabsWithdrawRequestAction() throws InterruptedException, IOException {
	...
	@Test
	public void Wa_TC_PlayerProfileTest_ActionViewTabsWithdrawRequestCreateNew()
			throws InterruptedException, IOException {
...
//	@Test
//	public void Wb_TC_PlayerProfileTest_ActionViewTabsWithdrawRequestApprove() throws InterruptedException, IOException 
//	{
//		String SearchItemWithdrawRequest="Bank Account";
...
//	
	...
	@Test
	public void X_TC_PlayerProfileTest_ActionViewTabsTrancsationHistorySearch()
			throws InterruptedException, IOException {
		...
		Thread.sleep(1000);
		gp.Search_Items(SearchItemTrancsationHistory);
		System.out.println("player Id " + SearchItemTrancsationHistory);
		Thread.sleep(1500);
	...
	@Test
	public void Z_TC_PlayerProfileTest_ActionViewTabsTrancsationHistoryXLSX() throws InterruptedException, IOException {
		// String SearchItem="XYZY";
		test = extentCreateTest(
	...
	@Test
	public void Za_TC_PlayerProfileTest_ActionViewTabsTrancsationHistoryAction()
			throws InterruptedException, IOException {
		// String SearchItem="XYZY";
	...
	@Test
	public void Zb_TC_PlayerProfileTest_ActionViewTabsPlayerLedgerSearch() throws InterruptedException, IOException {
		...
		if (driver.findElement(By.xpath("//h3[text()=\"View Player Details\"]")) != null) {
			...
			gp.Search_Items(SearchItemPlayerLedger);
			Thread.sleep(1500);
			// String
			// Searched=driver.findElement(By.xpath("//th[text()=\"Email\"]/following::tr//td[contains(text(),'"+SearchItem+"')]")).getText();

			// if(SearchItem.equalsIgnoreCase(SearchItem))
			if (driver.findElements(By.xpath("//tr//td[contains(text(),'" + SearchItemPlayerLedger + "')]"))
					.size() > 0) {
	...
	@Test
	public void Zd_TC_PlayerProfileTest_ActionViewTabsPlayerLedgerXLSX() throws InterruptedException, IOException {
		test = extentCreateTest(
	...
	@Test
	public void Ze_TC_PlayerProfileTest_ActionViewTabsPlayerLedgerAction() throws InterruptedException, IOException {
...
//			test.info("Testing Action View in TrancsationHistoryTab");
	...
	@Test
	public void Zf_TC_PlayerProfileTest_ActionViewTabsPlayerLedgerCheckTokens()
			throws InterruptedException, IOException {
	...
	@Test
	public void Zg_TC_PlayerProfileTest_ActionViewTabsSupportRequestSearch() throws InterruptedException, IOException {
		...
		if (driver.findElement(By.xpath("//h3[text()=\"View Player Details\"]")) != null) {
			...
			gp.Search_Items(SearchItemSupportRequest);
			Thread.sleep(1500);
			// String
			// Searched=driver.findElement(By.xpath("//th[text()=\"Email\"]/following::tr//td[contains(text(),'"+SearchItem+"')]")).getText();

			// if(SearchItem.equalsIgnoreCase(SearchItem))
			if (driver.findElements(By.xpath("//td[contains(text(),'" + SearchItemSupportRequest + "')]")).size() > 0) {
...
//	@Test
//	public void Zh_TC_PlayerProfileTest_ActionViewTabsSupportRequestPDF() throws InterruptedException, IOException 
//	{
//		//String SearchItem="XYZY";
...
//	
//	@Test
//	public void Zi_TC_PlayerProfileTest_ActionViewTabsSupportRequestXLSX() throws InterruptedException, IOException 
//	{
//		//String SearchItem="XYZY";
//		test = extentCreateTest("Player Profile -> SupportRequest -> Download Excel ");
//		test.info("TestCase started As an admin user I should be able to Download EXCEL in SupportRequest Tab");
//		GuestPlayers gp=new GuestPlayers(driver);
//		PlayerProfile pp=new PlayerProfile(driver);
//		CommonCosmo cc=new CommonCosmo(driver);
//
...
//			//Assert.assertTrue(true);
//			//test.info("Successfully Redirected to TrancsationHistoryTab");
//			test.info("Testing XLSX Download in support request");
//			pp.clickXlsxButton();
//			Thread.sleep(2000);
//			//String Searched=driver.findElement(By.xpath("//th[text()=\"Email\"]/following::tr//td[contains(text(),'"+SearchItem+"')]")).getText();
//			
//			//if(SearchItem.equalsIgnoreCase(SearchItem))
//			String msg="File download successfully.";
//			
//			
...
//				Thread.sleep(3000);
//				//this code is for download page comparsion
//				String modulename=ProfilePlayerId +" "+ driver.findElement(By.xpath("//button[contains(.,'Support Request')]")).getText();
//				Thread.sleep(2000);
//				driver.findElement(By.xpath("(//i[contains(@class,\"ri-download-cloud-2-line\")])[1]")).click();
//				Thread.sleep(2000);
//				
//				String downloadString=driver.findElement(By.xpath("(//th[text()=\"Listing Type\"]/following::tr//td[contains(@class,\"cdk-column-listingType\")])[1]")).getText();
//				
//				if(downloadString.equalsIgnoreCase(modulename))
//				{
//					test.pass("Successfully Viewed Listing Type	->"+downloadString);
...
//		else
//		{
//			test.fail("Something wrong !! To to found support request");
//			//Assert.assertTrue(false);			
//		}
//	}	

	@Test
	public void Zj_TC_PlayerProfileTest_ActionViewTabsSupportRequestCreateNew()
			throws InterruptedException, IOException {
		// String SearchItem="XYZY";
	...
	@Test
	public void Zk_TC_PlayerProfileTest_ActionViewTabsSupportRequestAction() throws InterruptedException, IOException {
		// String SearchItem="XYZY";
...
//			}
	...
	@Test
	public void Zl_TC_PlayerProfileTest_ActionViewTabsGameTransations_SlotSearch()
			throws InterruptedException, IOException {
	...
	@Test
	public void Zla_TC_PlayerProfileTest_ActionViewTabsGameTransations_KenoSearch()
			throws InterruptedException, IOException {
	...
	@Test
	public void Zlb_TC_PlayerProfileTest_ActionViewTabsGameTransations_FishSearch()
			throws InterruptedException, IOException {
...
//	@Test
//	public void Zh_TC_PlayerProfileTest_ActionViewTabsGameTransactionsPDF() throws InterruptedException, IOException 
//	{
//		//String SearchItem="XYZY";
//		//test.info("TestCase started As an admin user I should be able to Download PDF in SupportRequest Tab");
//		GuestPlayers gp=new GuestPlayers(driver);
...
//	}
	@Test
	public void Zm_TC_PlayerProfileTest_ActionViewTabsAppliedCoupons() throws InterruptedException, IOException {
	...
	@Test
	public void Zn_TC_PlayerProfileTest_CheckVerificationSymbol() throws InterruptedException, IOException {
...
//			}
	...
	@Test
	public void Zo_TC_PlayerProfileTest_CheckEmailVerificationSymbol() throws InterruptedException {
	...
	@Test
	public void Zp_TC_PlayerProfileTest_Footprints() throws InterruptedException {
		test = extentCreateTest("Player Login Footprints Test");
		bc.gotoTab(driver, 0);
		pp = new PlayerProfile(driver);
		gp = new GuestPlayers(driver);
		pp.clickOnPlayerManagement();
...
//	@Test
//    public void Zq_TC_PlayerProfileTest_PlayerIdLogin() throws InterruptedException
//    {
//        test=extentCreateTest("Website - Login With Player ID ");
//        
//        bc.gotoTab(driver, 1);
...
//        Thread.sleep(1000);
//        
//        String actualplayerID = driver.findElement(By.xpath("(//span[@class=\"mys-player-id\"])[1]")).getText();
//        String playerID=actualplayerID.substring(11, actualplayerID.length());
//        test.info("Player ID ->"+playerID);
//        wr.clickOnUserprofile();
//        Thread.sleep(500);
//        pp.clickOnLogoutBtn();
//        test.info("Player Logging with PlayerId");
//        Thread.sleep(1000);
//        test.info("Test case started for Login with PlayerId");
//        bc.WebsiteLogin(playerID, Playerpass);
//        test.pass("Player Logged with PlayerId",extentScreenshot());
//        
//        test.info("Test case End for Login with PlayerId");
//        bc.gotoTab(driver, 0);
//    }          

//	@Test
	public void Zr_TC_PlayerProfileTest_Donthaveaninvitecode() throws InterruptedException {
		...
		if (driver.findElement(By.xpath("//h2[text()='Request an Invite Code']")).isDisplayed()) {
			...
			cw.EnterPlayerFirstname(Firstnm);
			Thread.sleep(500);
			cw.EnterPlayerLastname(Lastnm);
			Thread.sleep(500);
			cw.EnterPlayerEmail(Email);
			Thread.sleep(500);
...
//	@Test
	public void Zs_TC_PlayerProfileTest_GameRTP() throws InterruptedException {
		test = extentCreateTest(
	...
	@Test
	public void Zsa_TC_PlayerProfileTest_ManageWalletAddCashApp() throws InterruptedException {
		String temp1;
	...
	@Test
	public void Zsb_TC_PlayerProfileTest_ManageWalletAddCashAppVerifyInWalletDeposit() throws InterruptedException {
...
//		 pp.clickOnPlayerProfile();
		...
		if (driver.findElements(By.xpath("//tbody//tr[1]//td//span[contains(text(),\"Success\")]")) != null
				&& driver.findElements(By.xpath("//tbody//tr[1]//td[normalize-space()='" + SearchPlayer + "']")) != null
				&& driver.findElements(By.xpath("//tbody//tr[1]//td[normalize-space()=\"Cash App\"]")) != null) {
			test.pass(
	...
	@Test
	public void Zsc_TC_PlayerProfileTest_ManageWalletAddCashAppVerifyWalletCount() throws InterruptedException {
	...
	@Test
	public void Zsd_TC_PlayerProfileTest_ManageWalletAddManual() throws InterruptedException {
		String amount = "20";
		String SearchPlayer = "CS-2579";
	...
	@Test
	public void Zse_TC_PlayerProfileTest_ManageWalletAddManualVerifyInWalletDeposit() throws InterruptedException {
		test = extentCreateTest("Verifying that data recently added in Wallet -> Deposits");
	...
	@Test
	public void Zsf_TC_PlayerProfileTest_ManageWalletAddCashAppVerifyWalletCount() throws InterruptedException {
	...
	@Test
	public void Zsg_TC_PlayerProfileTest_ManageWalletWithdrawCashApp() throws InterruptedException {
		String amount = "20";
		String SearchPlayer = "CS-2579";
	...
	@Test
	public void Zsh_TC_PlayerProfileTest_ManageWalletWithdrawManualVerifyInWalletDeposit() throws InterruptedException {
		test = extentCreateTest(
...
//	@Test
	public void Zsi_TC_PlayerProfileTest_ManageWalletAddCashAppVerifyWalletCount() throws InterruptedException {
		test = extentCreateTest("As an admin I should be able view wallet deposit count");
	...
	@Test
	public void Zsj_TC_PlayerProfileTest_ManageWalletWithdrawManual() throws InterruptedException {
	...
	@Test
	public void Zsk_TC_PlayerProfileTest_ManageWalletWithdrawCashAppVerifyInWalletDeposit()
...
//	@Test
	public void Zsl_TC_PlayerProfileTest_ManageWalletWithdrawCashAppVerifyWalletCount() throws InterruptedException {
		test = extentCreateTest("As an admin I should be able view wallet deposit count");
...
//	@Test
	public void Zx_TC_PlayerProfileTest__ViewNetReportofInvitedplayers() throws InterruptedException {
...
//	@Test
	public void Zy_TC_PlayerProfileTest__ViewPieChartofInvitedPlayers() throws InterruptedException {
...
//	@Test
	public void Zz_TC_PlayerProfileTest_PlayerLedger() throws InterruptedException {
...
//	@Test
	public void Zza_TC_PlayerProfileTest_ChargeBackReport() throws InterruptedException {
...
//	@Test
	public void Zzb_TC_PlayerProfileTest_PlayerTransactionGraph() throws InterruptedException {
		test = extentCreateTest(
