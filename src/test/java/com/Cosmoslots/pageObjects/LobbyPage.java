...
//	 }
	...
	public LobbyPage LobbyInfo_Click() {
		LobbyInfo.click();
		return this;
	}
	...
	public LobbyPage GeneralPages_Click() {
		GeneralPages.click();
		return this;
	}
	...
	public LobbyPage Settings_Click() {
		Settings.click();
		return this;
	}
	...
	public LobbyPage Set_HomePage_icon() {
		HomePage_icon.click();
		return this;
	}
	...
	public LobbyPage setAddMarketing_photo(String str) {
...
//		select_page.sendKeys(str);
	...
	public LobbyPage Set_ReleaseNotes() {
		ReleaseNotes.click();
		return this;
	}
	...
	public LobbyPage Set_Release_input(String str) {
		Release_input.clear();
	...
	public LobbyPage Set_Release_url(String str) {
		Release_url.clear();
		Release_url.sendKeys(str);
		return this;
	}

	public LobbyPage Player_Registration_Link(String desc) {
	...
	public LobbyPage ClickDesc(String desc) {
		description.clear();
		description.click();
	...
	public LobbyPage Maintenance_Desc(String desc) {
		description.clear();
		description.sendKeys(desc);
		return this;
	}
	...
	public LobbyPage clicklobbymanagement() {
		StoreManagement.click();
		return this;
	}

	public LobbyPage clickStoreAccounts() {
		StoreAccounts.click();
		return this;
	}

	public LobbyPage clickToCreate() {
		Create_Button.click();
		return this;
	}
	...
	public LobbyPage clickToEdit_FAQ() {
	...
	public LobbyPage clickViewLobby() {
		View_Click.click();
		return this;
	}

	public LobbyPage clickViewMaintenance() {
		View_Maintenance.click();
		return this;
	}

	public LobbyPage clickViewLobby_Profile() {
	...
	public LobbyPage clickView_LobbyStorePackage() {
		ViewLobby_storePackage.click();
		return this;
	}

	public LobbyPage clickViewLobby_LobbyCPackage() {
		ViewLobby_LobbyCPackage.click();
		return this;
	}

	public LobbyPage clickViewLobby_Game() {
		System.out
	...
	public LobbyPage clickViewLobby_Bonus() {
		ViewLobby_LobbyBonus.click();
		return this;
	}

	public LobbyPage clickViewLobby_coupon() {
		ViewLobby_coupon.click();
		return this;
	}

	public LobbyPage clickViewLobby_Withdraw() {
	...
	public LobbyPage clickViewLobby_CorporationDetails() {
		ViewLobby_CorporationDetails.click();
		return this;
	}

	public LobbyPage clickViewLobby_AppMarketing() {
		AppMarketinglabel.click();
		return this;
	}

	public LobbyPage clickViewLobby_CorporationDetails_name(String name) {
		ViewLobby_CorporationDetails_name.clear();
		ViewLobby_CorporationDetails_name.sendKeys(name);
		return this;
	}

	public LobbyPage clickViewLobby_CorporationDetails_contactNumber(String contactNumber) {
		ViewLobby_CorporationDetails_contactNumber.clear();
		ViewLobby_CorporationDetails_contactNumber.sendKeys(contactNumber);
		return this;
	}

	public LobbyPage clickViewLobby_CorporationDetails_email(String email) {
		ViewLobby_CorporationDetails_email.clear();
		ViewLobby_CorporationDetails_email.sendKeys(email);
		return this;
	}

	public LobbyPage clickViewLobby_CorporationDetails_address(String address) {
		ViewLobby_CorporationDetails_address.clear();
		ViewLobby_CorporationDetails_address.sendKeys(address);
		return this;
	}

	public LobbyPage ClickToSave() {
		Save_Button.click();
		return this;
	}

	public LobbyPage ClickToSave_GeneralPages() {
		Save_Button_GeneralPages.click();
		return this;
	}

	public LobbyPage ClickToYes() {
		clickyes.click();
		return this;
	}
	...
	public LobbyPage ClickToSaveFAQ() {
		Save_Button1.click();
		return this;
	}
	...
	public LobbyPage Set_Desc(String desc) {
		description.clear();
		description.sendKeys(desc);
		return this;
	}
	...
	public LobbyPage SearchItems(String key) {
		try {
			ldriver.findElement(By.xpath("//div[@class='gmuSearchBlock']//following::input[contains(@class,'ng')]"))
					.clear();
			ldriver.findElement(By.xpath("//div[@class='gmuSearchBlock']//following::input[contains(@class,'ng')]"))
	...
	public LobbyPage clickToViewPurchaseHistory() {
		ViewPurchaseHistory.click();
		return this;
	}

	public LobbyPage clickToViewCustomPurchaseHistory() {
		ViewCustomPurchaseHistory.click();
		return this;
	}

	public LobbyPage clickToViewCouponAppliedHistory() {
	...
	public LobbyPage View_Click() {
		View_Click.click();
		return this;
	}

	public LobbyPage ClickToClose() {
		Popup_Close_Button.click();
		return this;
	}

	public LobbyPage ClickToClose_Search() {
		Search_Close_Button.click();
		return this;
	}

	public LobbyPage ClickToCancel() {
		CancelButton.click();
		return this;
	}

	public LobbyPage clickTo_CreateBonus() {
		Create_Button.click();
		return this;
	}

	public LobbyPage setBonusName(String name) {
		Name.clear();
		Name.sendKeys(name);
		return this;
	}
	...
	public LobbyPage Setcoupon_discountedPercentage(String percentage) {
	...
	public LobbyPage Setcoupon_expiryAt() {
		expiryAt.click();
	...
	public LobbyPage Setcoupon_startDate(String date) {
		StartDate.click();
	...
	public LobbyPage clickToNews() {
		news.click();
		return this;
	}

	public LobbyPage clickToFAQ() {
		faq.click();
		return this;
	}

	public LobbyPage clickToPromotion() {
		Promotion.click();
		return this;
	}
	...
	public LobbyPage SetCategory() throws InterruptedException {
	...
	public LobbyPage SetOrder(String order) {
		SetOrder.sendKeys(order);
		return this;

	}

	public LobbyPage SetNewsicon(String name) {
	...
	public LobbyPage packageDeleteItems() {
		packageDeletebutton.click();
		return this;
	}

	public LobbyPage Deleteappsetings() {
		Deleteappsetings.click();
		return this;
	}

	public LobbyPage DeleteItems_Lobby() {
		Deletebutton_Lbonus.click();
		return this;
	}

	public LobbyPage DeleteClick_websiteSetings() {
	...
	public LobbyPage AppSetting_Company(String name) {
	...
	public LobbyPage AppSetting_website(String name) {
	...
	public LobbyPage AppSetting_TermsCondition(String name) {
	...
	public LobbyPage AppSetting_PrivacyPolicy(String name) {
	...
	public LobbyPage AppSetting_copyRights(String name) {
	...
	public LobbyPage AppSetting_ResponsibleGamingLink(String name) {
	...
	public LobbyPage AppSetting_RedemptionPolicyLink(String name) {
	...
	public LobbyPage AppSetting_SweepRulesLink(String name) {
	...
	public LobbyPage AppSetting_faqUrl(String name) {
...
//	        ldriver.findElement(By.xpath("//mat-option/span/span[text()=\"Canada\"]")).click();
	...
	public LobbyPage ClickOnJackpot() {
	...
	public LobbyPage DeleteItems() {
		Deletebutton.click();
		return this;
	}

	public LobbyPage setBonusAction() throws InterruptedException {
		var_Action.click();
		Thread.sleep(1000);
		select_Action.click();
		return this;
	...
	public LobbyPage GoToStoreEdit(String storeName) throws InterruptedException {
		CommonCosmo cc = new CommonCosmo(ldriver);
	...
	public LobbyPage CreateBonusLevel2(String bonusName, String numRefferal, String rechargeAmount, String st,
...
//			ldriver.findElement(By.xpath("//textarea[@formcontrolname='description']")).sendKeys(bonusName);
	...
	public LobbyPage SelectRadioBtn_MULTIPLE_DEPOSIT_BONUS() {
	...
	public LobbyPage SelectRadioBtn_MULTIPLE_BONUS() {
...
//		}
	...
	public LobbyPage set_SpinEventConfiguration( String GT_SpinsValue, String ST_SpinsValue) throws InterruptedException {
	...
	public LobbyPage set_Purchase_DepositAmount_ReminderSection(String remDepositAmount) throws InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) ldriver;
		Actions act = new Actions(ldriver);
		js.executeScript("arguments[0].scrollIntoView({block: 'center', inline: 'nearest'})", ReminderSection_header);
		Thread.sleep(2000);
	...
	public LobbyPage set_Purchase_PackagePurchase_ReminderSection(String numPkgPurchase) throws InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) ldriver;
		Actions act = new Actions(ldriver);
		js.executeScript("arguments[0].scrollIntoView({block: 'center', inline: 'nearest'})", ReminderSection_header);
		Thread.sleep(2000);
